...
def random_flip_image_and_annotation(image_tensor, image_shape):
    ...
    return randomly_flipped_img, tf.reshape(original_shape, name="reshape_random_flip_image_and_annotation"), image_shape
...
def scale_image_with_crop_padding(image, image_shape, crop_size):
    ...
    return image_croped, image_shape
